...
export function Login() {
  ...
  const handleGoogleSuccess = async (credentialResponse) => {
    try {
      ...
      console.error("Fallo la autenticación con Google", err);
    }
  };
    ...
    <div className="min-h-screen md:h-screen bg-ds-bg flex flex-col md:flex-row relative overflow-hidden">
      ...
      <div className="w-full md:w-1/2 lg:w-5/12 flex flex-col px-6 sm:px-12 lg:px-16 py-8 z-10 relative bg-ds-bg h-full overflow-y-auto">
        ...
        <div className="max-w-md w-full mx-auto my-auto py-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              <div className="flex justify-end mt-1.5">
                <Link 
                  to="/forgot-password" 
                  className="text-xs font-medium text-ds-primary hover:text-cyan-400 transition-colors"
                >
          ...
          <div className="w-full flex justify-center overflow-hidden rounded-xl border border-white/10 hover:border-white/20 transition-all">
            <GoogleLogin
